package com.seunghwan.portfolio.domain.entity
...
class Project(
    ...
    fun update(name: String, description: String, starYear: Int, startMonth: Int, endYear: Int?, endMonth: Int?, isActive: Boolean){
        this.name = name
